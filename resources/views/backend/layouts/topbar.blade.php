<div class="app-header">
    <div class="app-header__logo">
        <div class="logo-src"><h4 style="text-align:left;font-weight: bold;line-height:20px;"><img src="/assets/images/LogoWika.png" alt="" width="65" class="mx-4" style="margin-top: -10px"></h4></div>
                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <a class="dropdown-item" href="{{ URL :: to('') }}"> <i
